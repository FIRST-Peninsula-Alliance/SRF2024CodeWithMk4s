...
public final class Constants {
    ...
    public static final class AutoC {       // AutoC = short for AutoConstants
        ...
        public static final double AUTO_MAX_ACCEL_M_PER_SEC2 = 1.0;      // was 3
        public static final double AUTO_MAX_ANG_VEL_RAD_PER_SEC = 4.0*Math.PI;      // was 4
        public static final double AUTO_MAX_ANG_ACCEL_RAD_PER_SEC2 = 1.0*Math.PI;    // was 2
        ...
        public static final double AUTO_ACCEL_FACTOR_GENERIC = 0.8;
    }
}
