...
public class TestSquareAuto extends SequentialCommandGroup {
    ...
    Trajectory exampleTrajectory1 =
        TrajectoryGenerator.generateTrajectory(
            ...
            List.of(new Translation2d(0.25, 0.0),  // Pass through 1M forward
                    new Translation2d(0.5, 0.0),  // Waypt at 2M forward
                    new Translation2d(0.5, 0.25),  // Pass thru 1M west
                    new Translation2d(0.5, 0.5),  // Waypt at 2M, 2M
                    new Translation2d(0.25, 0.52),  // back up thru 1M
                    new Translation2d(0.0, 0.52),  // Waypt at 0, 2M
                    new Translation2d(0.0, 0.25)), // Move east thru 1M
    ...
    Trajectory exampleTrajectory2 =
        TrajectoryGenerator.generateTrajectory(
            ...
            new Pose2d(0.0, 0.0, new Rotation2d(0.0)),
            List.of(new Translation2d(0.0, 0.25),  // first moving W
                    new Translation2d(0.0, 0.5),
                    new Translation2d(0.25, 0.5),  // then N
                    new Translation2d(0.5, 0.5),
                    new Translation2d(0.5, 0.25),  // then E
                    new Translation2d(0.5, 0.0),
                    new Translation2d(0.25, 0.0)), // and finally back S
